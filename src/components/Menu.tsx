...
export default function Menu() {
    return (
        ...
        >
            ...
            <MenuItem icon={<IconArrowDownSquare />} texto="Comunicação Direta" url="/comunicacao/direta" />
            <MenuItem icon={<IconArrowUpSquare />} texto="Comunicação indireta" url="/comunicacao/indireta" />
